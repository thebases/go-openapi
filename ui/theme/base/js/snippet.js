...
const LANGUAGES = [
  { id: 'curl', label: 'CURL', icon:'img/bash-plain.svg' },
  { id: 'csharp', label: 'CSHARP', icon:'img/csharp-original.svg' },
  { id: 'go', label: 'GO' , icon:'img/go-original-wordmark.svg'},
  { id: 'node', label: 'NODEJS', icon:'img/nodejs-original.svg' },
  { id: 'ruby', label: 'RUBY' , icon:'img/ruby-plain.svg'},
  { id: 'php', label: 'PHP', icon:'img/php-original.svg' },
  { id: 'javascript', label: 'JAVASCRIPT', icon:'img/javascript-original.svg' },
  { id: 'python', label: 'PYTHON' , icon:'img/python-original.svg'},
  { id: 'java', label: 'JAVA', icon:'img/java-original.svg' },
  { id: 'c', label: 'C', icon:'img/c-original.svg' },
  { id: 'swift', label: 'SWIFT', icon:'img/swift-original.svg' },
  { id: 'objc', label: 'OBJECTIVE-C' , icon:'img/objectivec-plain.svg'},
  { id: 'kotlin', label: 'KOTLIN' , icon:'img/kotlin-original.svg'},
  { id: 'rust', label: 'RUST', icon:'img/rust-original.svg' },
  { id: 'powershell', label: 'POWERSHELL', icon:'img/windows8-original.svg' },
  { id: 'dart', label: 'DART' , icon:'img/dart-original.svg'},
  { id: 'lua', label: 'LUA', icon:'img/lua.svg' },
];
