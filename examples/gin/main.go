...
func main() {
	...
	if err := docs.RegisterSchema("MerchantUpsertRequest", openapi.InlineSchema(&openapi.Schema{
		Type: "object",
		Example: map[string]any{
			"name":   "The Base Labs",
			"status": "active",
	...
	if err := docs.RegisterSchema("AuthSession", openapi.InlineSchema(&openapi.Schema{
		Type: "object",
		Example: map[string]any{
	...
	err = api.GET(router, docs, openapi.Route("/auth/apikey/profile", openapi.Operation{
	...
	err = api.GET(router, docs, openapi.Route("/auth/oauth/session", openapi.Operation{
	...
	err = api.POST(router, docs, openapi.Route("/merchants", openapi.Operation{
