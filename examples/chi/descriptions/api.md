...
Sample API built with [`go-openapi`](https://github.com/thebases/go-openapi) and Chi, demonstrating typed route
...
Defaults to port `3000` (override with the `PORT` env var). Docs UI: `http://localhost:3000/docs/`. Raw document:
